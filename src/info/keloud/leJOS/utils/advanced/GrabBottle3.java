...
public class GrabBottle3 extends AbstractUtil {
    private Arm arm;
    private SearchGyro searchGyro;
    private boolean usePutBottle;

    public GrabBottle3(AbstractMotor centerMotor, AbstractMotor leftMotor, AbstractMotor rightMotor, UltrasonicSensor ultrasonicSensor, ColorSensor colorSensor, Arm arm, SearchGyro searchGyro) {
